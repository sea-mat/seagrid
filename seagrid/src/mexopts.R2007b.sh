...
#            FCLIBDIR="/mathworks/hub/share/apps/BuildTools/Linux/glibc-2.3.2/i686/g95/g95-0.50-tmw-000/lib/gcc-lib/i686-pc-linux-gnu/4.0.3"
...
#            FC="g95"
#            LD="g++"
#			# This must point to the location of libg95
#            FCLIBDIR="/sw/lib"
#            FLIBS="-L$FCLIBDIR -lg95 $FLIBS "
#
#           mac (gfortran)
            FC="gfortran"
            LD="g++"
			# This must point to the location of libgfortran
            FCLIBDIR="/sw/lib/gcc4.4/lib"
            FLIBS="-L$FCLIBDIR -lgfortran $FLIBS "
#
#           FC="$FC"
#           FFLAGS="$FFLAGS"
