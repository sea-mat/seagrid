...
rem
rem    $Revision: 1.1.6.5 $  $Date: 2007/12/06 13:15:28 $
rem
rem ********************************************************************
...
rem ********************************************************************
set COMPILER=ifort
set COMPFLAGS=/fpp /Qprec "/I%MATLAB%/extern/include" -c -nologo -DMATLAB_MEX_FILE /fixed /MD /fp:source
set OPTIMFLAGS=-Ox -DNDEBUG /real_size:64
set DEBUGFLAGS=-Zi /PDB:"%OUTDIR%%MEX_NAME%%MEX_EXT%.pdb"
set NAME_OBJECT=/Fo
